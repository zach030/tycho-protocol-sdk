        ...
        pub fn decode(log: &substreams_ethereum::pb::eth::v2::Log) -> Result<Self, String> {
            ...
            Ok(Self {
                src: ethabi::decode(&[ethabi::ParamType::Address], log.topics[1usize].as_ref())
                    .map_err(|e| {
                        format!("unable to decode param 'src' from topic of type 'address': {e:?}")
                    })?
                    .pop()
                    .expect(INTERNAL_ERR)
                    .into_address()
                ...
                guy: ethabi::decode(&[ethabi::ParamType::Address], log.topics[2usize].as_ref())
                    .map_err(|e| {
                        format!("unable to decode param 'guy' from topic of type 'address': {e:?}")
                    })?
                    .pop()
                    .expect(INTERNAL_ERR)
                    .into_address()
        ...
        pub fn decode(log: &substreams_ethereum::pb::eth::v2::Log) -> Result<Self, String> {
            ...
            Ok(Self {
                dst: ethabi::decode(&[ethabi::ParamType::Address], log.topics[1usize].as_ref())
                    .map_err(|e| {
                        format!("unable to decode param 'dst' from topic of type 'address': {e:?}")
                    })?
                    .pop()
                    .expect(INTERNAL_ERR)
                    .into_address()
