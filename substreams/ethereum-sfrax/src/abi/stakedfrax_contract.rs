...
pub mod functions {
    ...
    impl substreams_ethereum::rpc::RPCDecodable<substreams::scalar::BigInt> for Precision {
    ...
    impl substreams_ethereum::rpc::RPCDecodable<substreams::scalar::BigInt> for UnderlyingPrecision {
        fn output(data: &[u8]) -> Result<substreams::scalar::BigInt, String> {
            Self::output(data)
        }
    }
    ...
    impl substreams_ethereum::rpc::RPCDecodable<substreams::scalar::BigInt> for StoredTotalAssets {
        fn output(data: &[u8]) -> Result<substreams::scalar::BigInt, String> {
            Self::output(data)
        }
    }
...
pub mod events {
    ...
    impl DistributeRewards {
        const TOPIC_ID: [u8; 32] = [
            185u8, 209u8, 150u8, 165u8, 133u8, 193u8, 168u8, 148u8, 246u8, 72u8, 57u8, 62u8, 199u8,
            213u8, 44u8, 197u8, 159u8, 246u8, 217u8, 65u8, 145u8, 87u8, 157u8, 7u8, 59u8, 163u8,
            43u8, 10u8, 116u8, 215u8, 247u8, 166u8,
        ];
        pub fn match_log(log: &substreams_ethereum::pb::eth::v2::Log) -> bool {
    ...
    impl SetMaxDistributionPerSecondPerAsset {
        const TOPIC_ID: [u8; 32] = [
            5u8, 213u8, 48u8, 240u8, 253u8, 105u8, 116u8, 183u8, 217u8, 149u8, 253u8, 59u8, 113u8,
            135u8, 15u8, 83u8, 1u8, 187u8, 159u8, 224u8, 134u8, 24u8, 11u8, 221u8, 11u8, 211u8,
            101u8, 38u8, 114u8, 143u8, 92u8, 107u8,
        ];
        pub fn match_log(log: &substreams_ethereum::pb::eth::v2::Log) -> bool {
            if log.topics.len() != 1usize {
                return false;
    ...
    impl SyncRewards {
        const TOPIC_ID: [u8; 32] = [
            195u8, 42u8, 84u8, 110u8, 217u8, 88u8, 73u8, 14u8, 55u8, 243u8, 3u8, 53u8, 229u8, 1u8,
            224u8, 163u8, 148u8, 56u8, 203u8, 101u8, 10u8, 72u8, 81u8, 191u8, 212u8, 183u8, 117u8,
            73u8, 10u8, 242u8, 157u8, 173u8,
        ];
        pub fn match_log(log: &substreams_ethereum::pb::eth::v2::Log) -> bool {
            if log.topics.len() != 1usize {
                return false;
    ...
    impl TimelockTransferStarted {
        const TOPIC_ID: [u8; 32] = [
            22u8, 41u8, 152u8, 185u8, 10u8, 188u8, 37u8, 7u8, 243u8, 149u8, 58u8, 167u8, 151u8,
            130u8, 123u8, 3u8, 161u8, 76u8, 66u8, 219u8, 217u8, 163u8, 95u8, 9u8, 254u8, 175u8,
            2u8, 224u8, 213u8, 146u8, 119u8, 58u8,
        ];
        pub fn match_log(log: &substreams_ethereum::pb::eth::v2::Log) -> bool {
            if log.topics.len() != 3usize {
                return false;
    ...
    impl TimelockTransferred {
        const TOPIC_ID: [u8; 32] = [
            49u8, 182u8, 197u8, 160u8, 75u8, 6u8, 155u8, 110u8, 193u8, 179u8, 206u8, 244u8, 76u8,
            78u8, 124u8, 30u8, 173u8, 215u8, 33u8, 52u8, 156u8, 218u8, 152u8, 35u8, 208u8, 177u8,
            135u8, 123u8, 53u8, 81u8, 205u8, 198u8,
        ];
        pub fn match_log(log: &substreams_ethereum::pb::eth::v2::Log) -> bool {
            if log.topics.len() != 3usize {
                return false;
