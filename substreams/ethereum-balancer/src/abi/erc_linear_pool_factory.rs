...
pub mod functions {
    ...
    impl Create {
        const METHOD_ID: [u8; 4] = [118u8, 137u8, 91u8, 231u8];
...
pub mod events {
    use super::INTERNAL_ERR;
    #[derive(Debug, Clone, PartialEq)]
    pub struct Erc4626LinearPoolCreated {
        pub pool: Vec<u8>,
        pub protocol_id: substreams::scalar::BigInt,
    }
    impl Erc4626LinearPoolCreated {
        const TOPIC_ID: [u8; 32] = [
            69u8, 221u8, 97u8, 93u8, 46u8, 215u8, 153u8, 79u8, 152u8, 254u8, 200u8, 55u8, 178u8,
            208u8, 146u8, 175u8, 147u8, 60u8, 101u8, 32u8, 184u8, 113u8, 124u8, 58u8, 100u8, 49u8,
            121u8, 97u8, 202u8, 165u8, 50u8, 234u8,
        ];
    ...
    impl substreams_ethereum::Event for Erc4626LinearPoolCreated {
        const NAME: &'static str = "Erc4626LinearPoolCreated";
