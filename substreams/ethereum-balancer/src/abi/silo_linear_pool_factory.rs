...
pub mod events {
    ...
    #[derive(Debug, Clone, PartialEq)]
    pub struct SiloLinearPoolCreated {
        pub pool: Vec<u8>,
        pub protocol_id: substreams::scalar::BigInt,
    }
    impl SiloLinearPoolCreated {
        const TOPIC_ID: [u8; 32] = [
            51u8, 255u8, 20u8, 158u8, 158u8, 34u8, 79u8, 133u8, 82u8, 43u8, 217u8, 79u8, 245u8,
            135u8, 189u8, 84u8, 170u8, 248u8, 170u8, 90u8, 22u8, 253u8, 146u8, 79u8, 240u8, 1u8,
            55u8, 93u8, 114u8, 156u8, 173u8, 41u8,
        ];
        pub fn match_log(log: &substreams_ethereum::pb::eth::v2::Log) -> bool {
    ...
    impl substreams_ethereum::Event for SiloLinearPoolCreated {
        const NAME: &'static str = "SiloLinearPoolCreated";
        fn match_log(log: &substreams_ethereum::pb::eth::v2::Log) -> bool {
            Self::match_log(log)
        }
        fn decode(log: &substreams_ethereum::pb::eth::v2::Log) -> Result<Self, String> {
