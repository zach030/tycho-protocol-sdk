    ...
    pub mod functions {
        ...
        pub struct Create {
            ...
            pub amplification_parameter: substreams::scalar::BigInt,
            pub rate_providers: Vec<Vec<u8>>,
            pub token_rate_cache_durations: Vec<substreams::scalar::BigInt>,
            pub exempt_from_yield_protocol_fee_flag: bool,
            pub swap_fee_percentage: substreams::scalar::BigInt,
            pub owner: Vec<u8>,
            pub salt: [u8; 32usize],
        }
        impl Create {
            const METHOD_ID: [u8; 4] = [151u8, 30u8, 24u8, 51u8];
            pub fn decode(
                ...
                Ok(Self {
                    ...
                    rate_providers: values
                        ...
                        .collect(),
                    token_rate_cache_durations: values
                        .pop()
                        .expect(INTERNAL_ERR)
                        .into_array()
                        .expect(INTERNAL_ERR)
                        ...
                        .collect(),
                    exempt_from_yield_protocol_fee_flag: values
                        .pop()
                        .expect(INTERNAL_ERR)
                        .into_bool()
                        .expect(INTERNAL_ERR),
                    ...
                    &[
                        ...
                        ethabi::Token::Uint(
                            ethabi::Uint::from_big_endian(
                                match self.amplification_parameter.clone().to_bytes_be() {
                        ...
                        ethabi::Token::Bool(
                            self.exempt_from_yield_protocol_fee_flag.clone(),
                        ),
                        ethabi::Token::Uint(
                            ethabi::Uint::from_big_endian(
