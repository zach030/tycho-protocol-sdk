    ...
    pub mod functions {
        ...
        impl Create {
            const METHOD_ID: [u8; 4] = [113u8, 134u8, 30u8, 222u8];
            pub fn decode(
        ...
        impl Lookup {
            const METHOD_ID: [u8; 4] = [198u8, 151u8, 33u8, 122u8];
            pub fn decode(
                call: &substreams_ethereum::pb::eth::v2::Call,
            ) -> Result<Self, String> {
                let maybe_data = call.input.get(4..);
        ...
        impl substreams_ethereum::Function for Lookup {
        ...
        impl substreams_ethereum::rpc::RPCDecodable<Vec<u8>> for Lookup {
            fn output(data: &[u8]) -> Result<Vec<u8>, String> {
                Self::output(data)
            }
        }
        ...
        pub struct Position {}
        impl Position {
            const METHOD_ID: [u8; 4] = [9u8, 33u8, 142u8, 145u8];
            pub fn decode(
                call: &substreams_ethereum::pb::eth::v2::Call,
            ) -> Result<Self, String> {
                Ok(Self {})
        ...
        impl substreams_ethereum::rpc::RPCDecodable<Vec<u8>> for Position {
            fn output(data: &[u8]) -> Result<Vec<u8>, String> {
                Self::output(data)
            }
        }
        #[derive(Debug, Clone, PartialEq)]
        pub struct ProtocolFeeRatio {}
        impl ProtocolFeeRatio {
            const METHOD_ID: [u8; 4] = [122u8, 39u8, 217u8, 246u8];
            pub fn decode(
                call: &substreams_ethereum::pb::eth::v2::Call,
            ) -> Result<Self, String> {
                Ok(Self {})
        ...
        impl substreams_ethereum::Function for ProtocolFeeRatio {
            const NAME: &'static str = "protocolFeeRatio";
            fn match_call(call: &substreams_ethereum::pb::eth::v2::Call) -> bool {
                Self::match_call(call)
            }
            fn decode(
    ...
    pub mod events {
        ...
        #[derive(Debug, Clone, PartialEq)]
        pub struct SetFactoryOwner {
            pub owner: Vec<u8>,
        }
        impl SetFactoryOwner {
            const TOPIC_ID: [u8; 32] = [
                219u8,
                185u8,
                194u8,
        ...
        impl substreams_ethereum::Event for SetFactoryOwner {
            const NAME: &'static str = "SetFactoryOwner";
            fn match_log(log: &substreams_ethereum::pb::eth::v2::Log) -> bool {
                Self::match_log(log)
            }
            fn decode(
