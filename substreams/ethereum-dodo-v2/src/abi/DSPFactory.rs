...
pub mod functions {
    ...
    #[derive(Debug, Clone, PartialEq)]
    pub struct CreateDodoStablePool {
        pub base_token: Vec<u8>,
        pub quote_token: Vec<u8>,
    ...
    impl CreateDodoStablePool {
        const METHOD_ID: [u8; 4] = [207u8, 92u8, 47u8, 16u8];
        pub fn decode(call: &substreams_ethereum::pb::eth::v2::Call) -> Result<Self, String> {
            let maybe_data = call.input.get(4..);
            if maybe_data.is_none() {
                return Err("no data to decode".to_string());
    ...
    impl substreams_ethereum::Function for CreateDodoStablePool {
        const NAME: &'static str = "createDODOStablePool";
        fn match_call(call: &substreams_ethereum::pb::eth::v2::Call) -> bool {
            Self::match_call(call)
        }
        fn decode(call: &substreams_ethereum::pb::eth::v2::Call) -> Result<Self, String> {
    ...
    impl substreams_ethereum::rpc::RPCDecodable<Vec<u8>> for CreateDodoStablePool {
        fn output(data: &[u8]) -> Result<Vec<u8>, String> {
            Self::output(data)
        }
    }
    ...
    #[derive(Debug, Clone, PartialEq)]
    pub struct DspTemplate {}
    impl DspTemplate {
        const METHOD_ID: [u8; 4] = [89u8, 53u8, 128u8, 104u8];
        pub fn decode(call: &substreams_ethereum::pb::eth::v2::Call) -> Result<Self, String> {
            Ok(Self {})
        }
        pub fn encode(&self) -> Vec<u8> {
    ...
    impl substreams_ethereum::Function for DspTemplate {
        const NAME: &'static str = "_DSP_TEMPLATE_";
        fn match_call(call: &substreams_ethereum::pb::eth::v2::Call) -> bool {
            Self::match_call(call)
        }
        fn decode(call: &substreams_ethereum::pb::eth::v2::Call) -> Result<Self, String> {
    ...
    impl substreams_ethereum::rpc::RPCDecodable<Vec<u8>> for DspTemplate {
        fn output(data: &[u8]) -> Result<Vec<u8>, String> {
            Self::output(data)
        }
    }
    ...
    #[derive(Debug, Clone, PartialEq)]
    pub struct UpdateDspTemplate {
        pub new_dsp_template: Vec<u8>,
    }
    impl UpdateDspTemplate {
        const METHOD_ID: [u8; 4] = [28u8, 221u8, 80u8, 148u8];
        pub fn decode(call: &substreams_ethereum::pb::eth::v2::Call) -> Result<Self, String> {
            let maybe_data = call.input.get(4..);
            if maybe_data.is_none() {
                return Err("no data to decode".to_string());
    ...
    impl substreams_ethereum::Function for UpdateDspTemplate {
        const NAME: &'static str = "updateDSPTemplate";
        fn match_call(call: &substreams_ethereum::pb::eth::v2::Call) -> bool {
            Self::match_call(call)
        }
        fn decode(call: &substreams_ethereum::pb::eth::v2::Call) -> Result<Self, String> {
...
pub mod events {
    ...
    impl NewDsp {
        const TOPIC_ID: [u8; 32] = [
            188u8, 16u8, 131u8, 162u8, 193u8, 197u8, 239u8, 49u8, 225u8, 63u8, 180u8, 54u8, 149u8,
            61u8, 34u8, 180u8, 120u8, 128u8, 207u8, 125u8, 178u8, 121u8, 194u8, 197u8, 102u8,
            107u8, 22u8, 8u8, 58u8, 253u8, 107u8, 157u8,
        ];
    ...
    impl substreams_ethereum::Event for NewDsp {
        const NAME: &'static str = "NewDSP";
    ...
    #[derive(Debug, Clone, PartialEq)]
    pub struct RemoveDsp {
        pub dsp: Vec<u8>,
    }
    impl RemoveDsp {
        const TOPIC_ID: [u8; 32] = [
            137u8, 109u8, 111u8, 78u8, 112u8, 104u8, 230u8, 209u8, 148u8, 165u8, 184u8, 75u8,
            242u8, 34u8, 213u8, 19u8, 151u8, 58u8, 13u8, 197u8, 174u8, 150u8, 135u8, 18u8, 61u8,
            92u8, 97u8, 50u8, 157u8, 68u8, 137u8, 242u8,
        ];
        pub fn match_log(log: &substreams_ethereum::pb::eth::v2::Log) -> bool {
            if log.topics.len() != 1usize {
                return false;
    ...
    impl substreams_ethereum::Event for RemoveDsp {
        const NAME: &'static str = "RemoveDSP";
        fn match_log(log: &substreams_ethereum::pb::eth::v2::Log) -> bool {
            Self::match_log(log)
        }
        fn decode(log: &substreams_ethereum::pb::eth::v2::Log) -> Result<Self, String> {
