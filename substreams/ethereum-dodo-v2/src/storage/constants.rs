...
pub(crate) const GSP_PMM_SLOTS: [StorageLocation; 11] =
    [GSP_B_SLOT, GSP_Q_SLOT, GSP_B0_SLOT, GSP_Q0_SLOT, GSP_R_SLOT, GSP_K_SLOT, GSP_I_SLOT, GSP_MT_FEE_RATE_SLOT, GSP_LP_FEE_RATE_SLOT, GSP_MT_FEE_BASE_SLOT, GSP_MT_FEE_QUOTE_SLOT];
